...
Commands for running scripts suppose that current dir is `version`, the directory containing this file. On Linux and MacOS you have to mark scripts as executables to be able to run them:
